...
/* ================================================================== */
/*  6. CHARGE! — mash SPACE to fuel the rocket (4 BARS + FRAMERULES)   */
/*     Winning early lets the framerule system exit at bar 2 or 3.     */
/* ================================================================== */
interface ChargeS {
  charge: number;
  launched: boolean;
...
/* ================================================================== */
/*  7. SURVIVE! — dodge the meteor shower (4 BARS + FRAMERULES)        */
/*     Losing early lets the framerule system exit at bar 2 or 3.      */
/* ================================================================== */
interface SurvS {
  px: number;
